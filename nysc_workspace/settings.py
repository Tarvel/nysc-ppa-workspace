...
# kombu doesn't ship a 'rediss' transport alias in all versions.
# Register it so rediss:// URLs map to the built-in redis transport.
# redis-py itself handles TLS when it sees the rediss:// scheme.
if CELERY_BROKER_URL.startswith('rediss://'):
    try:
        from kombu.transport import TRANSPORT_ALIASES
        TRANSPORT_ALIASES['rediss'] = 'kombu.transport.redis:Transport'
    except ImportError:
        pass
    import ssl
